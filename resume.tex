...
\photo[circle,edge,left]{moi}
\name{Roland}{Zhang}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\address{18 rue Jean Moulin, 78260 Achères}

\mobile{06 50 75 73 07}
\email{roland.zhang.pro@gmail.com}
%\dateofbirth{January 1st, 1970}
\github{github.com/RakanAD}
\linkedin{linkedin.com/in/roland-zhang}
\homepage{rakanad.github.io/Mon-Portfolio} 
%\homepage{https://www.youtube.com/@rolandfanzhang} 
% \gitlab{gitlab-id}
